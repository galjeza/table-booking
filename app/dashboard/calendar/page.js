                ...
                <div ref={container} className="flex flex-auto flex-col overflow-auto">
                    ...
                    <div className="flex w-full flex-auto">
                        ...
                        <div className="grid flex-auto grid-cols-1 grid-rows-1">
                            ...
                            >
                                <li className="relative mt-px flex" style={{ gridRow: '2 / span 12' }}>
                                    <a
                                        href="#"
                                        className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-blue-50 p-2 text-xs leading-5 hover:bg-blue-100"
                                    >
                                        <p className="order-1 font-semibold text-blue-700">Gal Jeza </p>
                                        <p className="order-1 text-blue-500 group-hover:text-blue-700">Miza 2</p>

                                        <p className="text-blue-500 group-hover:text-blue-700">
                                            <time dateTime="2022-01-22T06:00">8:00 - 9:00</time>
                                        </p>
                                    </a>
                                </li>
                                <li className="relative mt-px flex" style={{ gridRow: '20 / span 18' }}>
                                    <a
                                        href="#"
                                        className="group absolute inset-1 flex flex-col overflow-y-auto rounded-lg bg-pink-50 p-2 text-xs leading-5 hover:bg-pink-100"
                                    >
                                        <p className="order-1 font-semibold text-pink-700">Vid Čabrian</p>
                                        <p className="order-1 text-pink-500 group-hover:text-pink-700">
                                            Miza 1
                                        </p>
                                        <p className="text-pink-500 group-hover:text-pink-700">
                                            <time dateTime="2022-01-22T07:30">9:30 - 11:00</time>
                                        </p>
                                    </a>
                                </li>
                                <li className="relative mt-px flex " style={{ gridRow: '50 / span 10' }}>
                                    <a
                                        href="#"
                                    ...
                                    >
                                        <p className="order-1 font-semibold text-purple-700">Simon Plazar</p>
                                        <p className="order-1 text-purple-500 group-hover:text-purple-700">Miza 5</p>
