...
const AddTableModal  =({ restaurantId, reservations, setReservations,showModal,setShowModal }) =>{
    ...
    const addReservation = async () => {
        const res = await fetch('/api/reservations/create', {
            ...
            body: JSON.stringify({ restaurantId, partySize, startTime, endTime, customer, date})
        })
